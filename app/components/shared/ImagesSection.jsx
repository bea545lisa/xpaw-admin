...
export default function ImagesSection({
  ...
  const handleLightDrop = (e, targetIndex) => {
    ...
    if (payload.type === "light") {
      ...
      // Dark-Bild-Zuordnung wandert mit demselben (jetzt korrekten)
      // Zielindex mit, damit Light+Dark als Paar zusammenbleiben statt
      // sich nach dem Sortieren zu verschieben, waehrend das Dark-Bild
      // an der alten Position stehen bleibt.
